...
import img from "./Maxsulotlar/Komptex/1.jpg"
import phonk from "./Maxsulotlar/Komptex/2.jpg"
import camera from "./Maxsulotlar/Komptex/3.jpg"
import mug from "./Maxsulotlar/Komptex/4.jpg"
import iphone from "./Maxsulotlar/Komptex/5.jpg"
    ...
    <div className="flex  gap-8 px-6 py-10 max-w-[1300px] mx-auto">
      ...
      <div className="w-[220px] flex-shrink-0">
        ...
        <div className="text-sm text-gray-500 flex items-center gap-1 mb-3">
          ...
          <span className="text-gray-700 font-medium">Kompiyuter texnikasi</span>
        </div>
