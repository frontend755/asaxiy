...
import img from "./Maxsulotlar/texnika/download.jpg"
import phonk from "./Maxsulotlar/texnika/download (1).jpg"
import camera from "./Maxsulotlar/texnika/download (2).jpg"
import mug from "./Maxsulotlar/texnika/download (3).jpg"
import iphone from "./Maxsulotlar/texnika/download (4).jpg"
import samsung from "./Maxsulotlar/texnika/download (5).jpg"
import xonor from "./Maxsulotlar/texnika/download (6).jpg"
import redmi from "./Maxsulotlar/texnika/download (7).jpg"
import hp from "./Maxsulotlar/texnika/download (8).jpg"
import acer from "./Maxsulotlar/texnika/download (9).jpg"
import mac from "./Maxsulotlar/texnika/download (10).jpg"
import asus from "./Maxsulotlar/texnika/download (11).jpg"
import cpu from "./Maxsulotlar/texnika/download (12).jpg"
import power from "./Maxsulotlar/texnika/images.jpg"
import ryzen from "./Maxsulotlar/texnika/images (1).jpg"
import intl from "./Maxsulotlar/texnika/images (2).jpg"
import monitor from "./Maxsulotlar/texnika/images (3).jpg"
import monitor1 from "./Maxsulotlar/texnika/images (4).jpg"
import chair from "./Maxsulotlar/texnika/images (5).jpg"
import quloqchin from "./Maxsulotlar/texnika/images (6).jpg"
function  Maishiy  (){

  const categories = [
    "Oshxona uchun katta texnika",
    "Uy uchun texnika",
    ...
    <div className="flex  gap-8 px-6 py-10 max-w-[1300px] mx-auto">
      ...
      <div className="w-[220px] flex-shrink-0">
        ...
        <div className="text-sm text-gray-500 flex items-center gap-1 mb-3">
          ...
          <span className="text-gray-700 font-medium">Maishiy texnika</span>
        </div>
