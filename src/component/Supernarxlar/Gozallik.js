...
import img from "./Maxsulotlar/Go'zallik/1.jpg"
    ...
    <div className="flex  gap-8 px-6 py-10 max-w-[1400px] mx-auto">
      ...
      <div className="w-[320px] flex-shrink-0">
        ...
        <div className="text-sm text-gray-500 flex items-center gap-1 mb-3">
          ...
          <span className="text-gray-700 font-medium">Go'zallik va salomatlik</span>
        </div>
      ...
      <h1 className="title " data-aos="fade-down">Go'zallik va salomatlik</h1>
