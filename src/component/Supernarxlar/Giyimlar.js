...
import img from "./Maxsulotlar/Geymerlaruch/1.webp"
// import phonk from "./Maxsulotlar/televizorva/2.webp"
// import camera from "./Maxsulotlar/televizorva/3.webp"
// import mug from "./Maxsulotlar/televizorva/4.webp"
// import iphone from "./Maxsulotlar/televizorva/5.webp"
    ...
    <div className="flex  gap-8 px-6 py-10 max-w-[1400px] mx-auto">
      ...
      <div className="w-[320px] flex-shrink-0">
        ...
        <div className="text-sm text-gray-500 flex items-center gap-1 mb-3">
          ...
          <span className="text-gray-700 font-medium">Geymerlar uchun tovarlar</span>
        </div>
      ...
      <h1 className="title " data-aos="fade-down">Geymerlar uchun tovarlar</h1>
