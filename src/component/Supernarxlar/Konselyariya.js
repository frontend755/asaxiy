...
import img from "./Maxsulotlar/Konsel/1.jpg"
import phonk from "./Maxsulotlar/Konsel/2.png"
// import camera from "./Maxsulotlar/idishras/3.webp"
    ...
    <div className="flex  gap-8 px-6 py-10 max-w-[1400px] mx-auto">
      ...
      <div className="w-[320px] flex-shrink-0">
        ...
        <div className="text-sm text-gray-500 flex items-center gap-1 mb-3">
          ...
          <span className="text-gray-700 font-medium">Konselyariya tovarlar</span>
        </div>
      ...
      <h1 className="title " data-aos="fade-down">Idish-tovoqlar</h1>
