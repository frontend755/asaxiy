...
import img from "./Maxsulotlar/Oyinchoqlarbol/3.webp"
import phonk from "./Maxsulotlar/Oyinchoqlarbol/2.webp"
import camera from "./Maxsulotlar/Oyinchoqlarbol/1.webp"
// import mug from "./Maxsulotlar/sportdam/4.webp"
// import iphone from "./Maxsulotlar/sportdam/5.png"
// import samsung from "./Maxsulotlar/Komptex/6.jpg"
...
function   Oyinchoqlar (){

  const categories = [
    "Musulmonlar uchun sovg'alar",
  ...
  return (
    <div className="flex  gap-8 px-6 py-10 max-w-[1400px] mx-auto">
      ...
      <div className="w-[320px] flex-shrink-0">
        {/* Breadcrumb */}
        <div className=" w-[500px] text-sm text-gray-500 flex items-center gap-1 mb-3">
          <Link to="/bosh" className="cursor-pointer hover:text-blue-600">
            Bosh sahifa
          </Link>
          <span className="text-gray-400">{'>'}</span>
          <span className="text-gray-700 font-medium">O'yinchoqlar, sovg'alar va aksessuarla</span>
        </div>
      ...
      <h1 className="title " data-aos="fade-down">O'yinchoqlar, sovg'alar va aksessuarlar</h1>
