...
import img from "./Maxsulotlar/qurras/1.png"
import phonk from "./Maxsulotlar/qurras/2.jpg"
import camera from "./Maxsulotlar/qurras/3.png"
...
function   Qurilish (){
  ...
  const categories = [
    "uy uchun gajetlar",
    "Batareykalar va akumuliatorlar",
    "Organayzerlar",
    "Aqilli uy",
    ...
    <div className="flex  gap-8 px-6 py-10 max-w-[1400px] mx-auto">
      ...
      <div className="w-[320px] flex-shrink-0">
        ...
        <div className="text-sm text-gray-500 flex items-center gap-1 mb-3">
          ...
          <span className="text-gray-700 font-medium">Qurilish va ta'mirlash</span>
        </div>
      ...
      <h1 className="title " data-aos="fade-down">Qurilish va ta'mirlash</h1>
